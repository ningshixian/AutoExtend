...
%         RelationFiles{4} = 'antonym.txt';
    ...
    ThetaMap = table2array(Table(:, 1:2));    % ��һ��+�ڶ���
    % fprintf('ThetaMap %f\n', ThetaMap(:,1));
    % S = sparse(i,j,s,m,n,nzmax)  ��i,j,s������������һ��m*n��ϡ�����S,������ຬ��nzmax������Ԫ��
    Iota = sparse(ThetaMap(:,1),ThetaMap(:,2),ones(size(ThetaMap,1),1),countWords,countSynsets);    % ����Խ��
